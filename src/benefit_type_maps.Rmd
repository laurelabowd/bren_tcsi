...
benefits_map <- tm_shape(basemap_gray_large) +
  tm_rgb() +
...
# tmap_save(benefits_map, "benefits_map_count.png")
```
...
impacts_map <- tm_shape(basemap_gray_large) +
  tm_rgb() +
...
tm_shape(tcsi) +
  tm_borders("black", lwd = 2) +
tm_layout(title = "TCSI adverse impacts", 
            title.position = c("right", "top"),
          title.size = 1.5,
          title.bg.color = "white",
          legend.bg.color = "white",
...
#tmap_save(impacts_map, "impacts_map_count.png")
```
...
threats_map <- tm_shape(basemap_gray_large) +
  tm_rgb() +
...
#tmap_save(threats_map, "threats_map_count.png")
```
...
priorities_map <- tm_shape(basemap_gray_large) +
  tm_rgb() +
...
tm_shape(tcsi) +
  tm_borders("black", lwd = 2) +
tm_layout(title = "TCSI management priorities", 
            title.position = c("right", "top"),
          title.size = 1.5,
          title.bg.color = "white",
          legend.bg.color = "white",
...
#tmap_save(priorities_map, "priorities_map_count.png")
```

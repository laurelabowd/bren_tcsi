...
#tmap_save(benefits_map_nolegend, "benefits_map_count_nolegend_020922.png")
```
```{r}
tmap_mode(mode = "plot")
library(viridis)
...
#tmap_save(impacts_map_nolegend, "impacts_map_count_nolegend_020922.png")
```
...
#tmap_save(threats_map_nolegend, "threats_map_count_nolegend_020922.png")
```
...
#tmap_save(priorities_map_nolegend, "priorities_map_count_nolegend_020922.png")
```

...
#tmap_save(benefits_map_nolegend, "benefits_map_count_nolegend.png")
```
```{r}
tmap_mode(mode = "plot")
library(viridis)
...
#tmap_save(impacts_map_nolegend, "impacts_map_count_nolegend.png")
```
...
#tmap_save(threats_map_nolegend, "threats_map_count_nolegend.png")
```
...
# tmap_save(priorities_map_nolegend, "priorities_map_count_nolegendf.png")
```
